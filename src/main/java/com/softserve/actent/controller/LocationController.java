...
import com.softserve.actent.model.dto.location.LocationCoordinatesDto;
...
public class LocationController {
    ...
    @GetMapping(value = "coordinates/{address}")
    @ResponseStatus(HttpStatus.OK)
    public LocationCoordinatesDto getCoordinates(@PathVariable @NotBlank(message = StringConstants.EMPTY_LOCATION)
                                                 @Length(min = NumberConstants.LOCATION_MIN_LENGTH,
                                                         ...
                                                         String address) {
        return modelMapper.map(locationService.getByCoordinates(address), LocationCoordinatesDto.class);
    }
